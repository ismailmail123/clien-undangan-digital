            ...
            <Card className="card-two" style={{ marginTop: 150 }} id="user">
              <div style={{ width: "75%" }}>
                <p className="text-center description1 lh-1">
                  The Wedding of Deta & Riska
                </p>
                <p className="text-center fw-bold" style={{ fontSize: 12 }}>
                  ِبِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيْم
                </p>
                <p className="text-center fw-bold" style={{ fontSize: 10 }}>
                  Atas Rahmat Tuhan Yang Maha Esa, kami bermaksud mengundang
                  Anda di acara Kami. Merupakan suatu kehormatan dan kebahagiaan
                  bagi kami sekeluarga, apabila Bapak/Ibu/Saudara/i berkenan
                  hadir dan memberikan doa restu pada
                </p>
              </div>
